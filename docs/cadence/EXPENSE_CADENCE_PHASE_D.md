...
| Entry | Example |
|-------|---------|
| **Chat** | “InsurerCo is yearly insurance — spread monthly” |
...
User wants AI-first cadence after loading a multi-year history export — not per-merchant code changes. InsurerCo manual rule (Phase C) is the reference outcome D1 should reproduce via chat + confirm.
