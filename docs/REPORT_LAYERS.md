...
Layer 1: cadence_rules + tx cadence   (InsurerCo annual → normalized monthly)
...
1. “InsurerCo is yearly insurance — spread it monthly” → chat saves `cadence_rules` row (confirm modal like edit insights) — **EXPENSE_CADENCE_PHASE_D Slice D1**
...
- Settings or Chat: “disable InsurerCo normalization layer”
...
- InsurerCo $900.00 annual → ~$75.00/mo normalized
