...
## 7. User-specific data notes

- **Mercury** appears under multiple `merchant_key`s: `Mercury Ins Mcc Ppa`, `Mercury Insurance`, `Mercury Casualty Co.` — not one payee.
- **$392.88** (2025-10-24) is `Mercury Insurance`; 6-month policy Oct 2025–Apr 2026; annual rule on `Mercury Ins Mcc Ppa` does not apply to that row.
- **May 2026** in DB: ~190 Expense, 54 Transfer, 3 Income, 6 Adjustment.
