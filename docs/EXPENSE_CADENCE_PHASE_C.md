...
Let users set cadence on the **Edit Transactions** panel without SQL or chat — e.g. mark Mercury as **every 12 months**, bi-weekly gym as **every 2 weeks**.

## User examples (from chat)

| Merchant | Charge | Cadence |
|----------|--------|---------|
| Mercury Ins | ~$928 once/year in April | `recurring_lump`, 12 months |
...
```text
Cash: $928.87  |  Core: $0  |  Normalized: $77.41/mo
```
...
1. Open Edit → select Mercury April row
