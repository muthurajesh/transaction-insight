...
- "Why was Mercury classified as Utilities?"
...
-- Example: Cadence Agent remembers "user said Mercury is 6-month policy, not 12"
-- { "agent": "cadence", "type": "merchant_fact", "key": "Mercury Insurance", 
...
| **Semantic** | `agent_memory` + `merchant_labels` | Permanent | "Mercury Insurance is 6-month policy" |
