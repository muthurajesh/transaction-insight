...
**Expected:** `top_categories(month=2026-04, limit=10)` → category rollup for full April (~$10.7k, 157 txs).
...
Result: `list_transactions(month=2026-04, limit=10)` → **10 newest rows**, total **$599.44**, not top categories.
...
3. Insurance ~$2,097, Groceries ~$1,308 — not $599 total
4. Mark `[x]` in `docs/ROADMAP.md` §2
