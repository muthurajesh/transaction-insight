...
| View | Mercury $928.87 in May | Semi-annual $600 in May |
|------|------------------------|-------------------------|
| **cash** | $928.87 (bank reality) | $600.00 |
| **core** | $0 (excluded from run-rate) | $0 |
| **normalized** | $77.41/mo (`/12`) | $100/mo (`/6`) |

User example from chat: **Mercury Ins Mcc Ppa** — annual premium should not dominate “monthly expense” views.
...
|------|------|--------------|
| April 2026 total expenses | ~$10,724 | Lower (annual lumps spread) |
| Mercury ~$975 in April | full amount in cash | ~$81/mo in normalized |
...
- User wants clarity on **monthly** vs **yearly** vs **one-time** (Mercury insurance)
