...
def test_effective_amount_views():
    assert effective_amount(-928.87, view="cash", kind=CADENCE_KIND_LUMP, period_count=12, period_unit="months") == 928.87
    assert effective_amount(-928.87, view="core", kind=CADENCE_KIND_LUMP, period_count=12, period_unit="months", include_in_run_rate=False) == 0.0
    assert effective_amount(-928.87, view="normalized", kind=CADENCE_KIND_LUMP, period_count=12, period_unit="months") == 77.41
