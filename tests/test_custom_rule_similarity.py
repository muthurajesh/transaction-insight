...
class CustomRuleSimilarityTests(unittest.TestCase):
    ...
    def test_find_by_merchant_and_category(self):
        existing = [
            {
                "rule": "When Generated Description is *InsurerCo* set ai_category Insurance, type Fixed",
                "status": "Pending",
            }
        ]
        hit = find_similar_custom_rule(
            suggested_rule="When Generated Description is InsurerCo Prem Pay set ai_category Insurance, type Fixed",
