...
def _seed_annual_insurance(conn: sqlite3.Connection) -> None:
    conn.execute(
        ...
        ('t1', '2025-04-01', '2025-04', -928.87, 'Mercury Ins Mcc Ppa', 'Insurance', 'Expense', 'unknown', 'pipeline', 'now'),
        ('t2', '2024-04-01', '2024-04', -915.20, 'Mercury Ins Mcc Ppa', 'Insurance', 'Expense', 'unknown', 'pipeline', 'now'),
        ('t3', '2026-04-01', '2026-04', -928.87, 'Mercury Ins Mcc Ppa', 'Insurance', 'Expense', 'unknown', 'pipeline', 'now'),
...
class GatherCadencePatternTests(unittest.TestCase):
    def test_yearly_pattern_detected(self):
        ...
        pattern = gather_merchant_cadence_pattern(conn, "Mercury Ins Mcc Ppa")
...
class EditCadenceSuggestQueueTests(unittest.TestCase):
    ...
    def test_skips_merchant_with_existing_rule(self):
        ...
        self.assertNotIn("Mercury Ins Mcc Ppa", keys)
    ...
    def test_list_merchants_includes_ai_category(self):
        ...
        self.assertEqual(by_key["Mercury Ins Mcc Ppa"]["ai_category"], "Insurance")
