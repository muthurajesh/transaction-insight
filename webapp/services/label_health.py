...
- Merge ONLY the same real-world merchant with typos, truncation, or location suffix (e.g. "Cafe Branch A" -> "Cafe Downtown").
- Do NOT merge different check numbers ("Check 00000000211" vs "Check 00000000214").
- Do NOT merge bank transfers =In vs =Out, To vs From, different account numbers (CHK 1001 vs 2002), or different confirmation IDs.
