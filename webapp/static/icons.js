/** Lucide-style icons (MIT). Paths only — render via icon() or data-icon. */
(function (global) {
  const PATHS = {
    ...
    "mic-off":
      '<line x1="2" x2="22" y1="2" y2="22"/><path d="M18.89 13.23A7.12 7.12 0 0 0 19 12v-2"/><path d="M5 10v2a7 7 0 0 0 12 4"/><path d="M15 9.34V5a3 3 0 0 0-5.68-1.33"/><path d="M9 9v3a3 3 0 0 0 5.12 2.12"/><line x1="12" x2="12" y1="19" y2="22"/>',
    "circle-help":
    ...
    replace:
      '<path d="M14 4h6"/><path d="m19 4-3 3"/><path d="M4 7V4"/><path d="m4 4 3 3"/><path d="M10 4h2a4 4 0 0 1 4 4v2"/><path d="M10 20h2a4 4 0 0 0 4-4v-2"/>',
    eye:
  ...
  function btnIconLabel(name, text, { size = 16, className = "btn-icon-label" } = {}) {
    return `${icon(name, { size })}<span>${text}</span>`;
  }

  function setIcon(el, name, options) {
    if (!el) return;
  ...
  function hydrateIcons(root = document) {
    root.querySelectorAll("[data-icon]").forEach((el) => {
      ...
      const className = el.getAttribute("data-icon-class") || "";
      el.innerHTML = icon(name, { size, className });
    });
  }

  global.icon = icon;
  global.btnIconLabel = btnIconLabel;
